...
function insertNewRecord(data) {
    ...
    cell4.innerHTML = data.monthlysalary;
...
function onEdit(td) {
    ...
    document.getElementById("monthlysalary").value = selectedRow.cells[3].innerHTML;
}
function updateRecord(formData) {
    selectedRow.cells[0].innerHTML = formData.fullName;
    selectedRow.cells[1].innerHTML = formData.work;
    selectedRow.cells[2].innerHTML = formData.address;
    selectedRow.cells[3].innerHTML = formData.monthlysalary;
}
